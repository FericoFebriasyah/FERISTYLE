...
<head>
    ...
    <title>Produk - Feristyle Admin</title>
...
<body>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped mt-2">
                                ...
                                <tbody>
                                    ...
                                    $sql_query = isset($_GET['query']) ? mysqli_real_escape_string($koneksi, $_GET['query']) :  '';
    ...
    <footer id="footer" class="footer">
        ...
        <div class="credits">
            Designed by <a href="https://www.instagram.com/fericorajinngaji?igsh=MTJ1cWZzbTN5OTQxZg%3D%3D&utm_source=qr">Ferico Febriansyah</a>
        </div>
    </footer><!-- End Footer -->
