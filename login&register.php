<?php
    ...
    <head>
        ...
        <title>Login & Register - Feristyle</title>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-lg-3">
                                <div class="widget widget-about">
                                    <a href="index.php" class="footer-logo">Feristyle</a>
                                    <p>Feristyle adalah destinasi fashion online yang menghadirkan koleksi pakaian stylish dan berkualitas. Temukan tren terbaru, nikmati promo eksklusif, dan rasakan pengalaman belanja yang mudah serta aman. Lengkapi gayamu bersama Outfitz!</p>


                                    <div class="social-icons">
                                        <a href="https://www.instagram.com/fericorajinngaji?igsh=MTJ1cWZzbTN5OTQxZg%3D%3D&utm_source=qr" class="social-icon" target="_blank" title="Instagram"><i class="icon-instagram"></i></a>
                                    </div><!-- End .soial-icons -->
                ...
                <div class="footer-bottom">
                    <div class="container">
                        <p class="footer-copyright">Copyright © 2025 Feristyle. All Rights Reserved.</p><!-- End .footer-copyright -->
