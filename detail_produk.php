...
<head>
    ...
    <title> Detail Produk - Feristyle</title>
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index.html" class="logo">
                            <span style="font-size:50px; font-weight: bold; font-family:Arial, sans-serif;">Feristyle</span>
                        </a>
                    </div><!-- End .header-left -->
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        ...
                                        <figure class="product-image-contaier">
                                    ...
                                    <div class="product">
                                        ...
                                        <a href="#" class="btn-remove" title="Remove Product"><i class="icon-clos"></i></a>
                                    </div><!-- End .product -->
                            ...
                            <div class="dropdown compare-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="compare-products">
                                        ...
                                        <li class="compare-product">
                                            <a href="#" class="btm-remove" title="Remove Product"><i class="icon-close"></i></a>
        ...
        <main class="main">
            ...
            <div class="page-content">
                <div class="container">
                    <div class="product-details-top">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                // Ambil id_produk dari paramenter GET atau POST
                                $id_produk = isset($_GET['id_produk']) ? $_GET['id_produk'] : 0;

                                // periksa apakah id_produk valid
                                if (!$id_produk) {
                                    die("<p>ID Produk tidak ditemukan. Silahkan cek kembali.</p>");
                                }

                                // Query untuk mendapatkan data produk dan kategori
                                $sql = "SELECT p.id_produk, p.nm_produk, p.harga, p.stok, p.ket, p.gambar, p.size, k.nm_ktg AS kategori FROM tb_produk p JOIN tb_ktg k ON p.id_ktg =k.id_ktg WHERE p.id_produk = ?";
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    <h1 class="product-title"><?php echo htmlspecialchars($produk['nm_produk']); ?></h1>
                                    <!-- End .product-title -->
                                    ...
                                    Rp. <?php echo number_format($produk['harga'],0,',','.'); ?></div>
                                    ...
                                    if (isset($_POST['add_to_cart'])) {
                                        ...
                                        if (!isset($_SESSION['id_user'])) { 
                                            ...
                                            window.location.href='user.php';</sript>";
                                            exit;
                                        }
                                    ...
                                    <div class="product-details-footer">
                                        <div class="product-cat">
                                            <span>Category:</span>
                                            <a href="#"><?php echo htmlspecialchars($produk['kategor']); ?></a>
                                        </div><!-- End .product-cat --> 
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="product-desc-tab" role="tabpanel" aria-labelledby="product-desc-link">
                                <div class="product-desc-content">
                                    ...
                                    <p><?php echo n12br(htmlspecialchars($produk['ket'])); ?></p>
                            ...
                            <div class="tab-pane fade" id="product-info-tab" role="tabpanel" aria-labelledby="product-info-link">
                                <div class="product-desc-content">
                                    ...
                                    <p>Stok: <strong><?php echo htmlspecialchars($produk['stok']); ?></strong></php>
                    ...
                    <?php
                    include "admin/koneksi.php";
                    $sql_related = "SELECT id_produk, nm_produk, harga, gambar FROM tb_produk WHERE id_produk != ? ORDER BY RAND() LIMIT 4";
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
                            ...
                            <span style="font-size:50px; font-weight: bold; font-family:Arial, sans-serif;">Feristyle</span>
	            				...
	            				<p>kas tampak keren dan elegan kaos khusus . </p>
