...
<head>
    ...
    <title>transaksi - Feristyle Admin</title>
...
<body>
 ...
 <aside id="sidebar" class="sidebar">
    ...
    <footer id="footer" class="footer">
        ...
        <div class="credits">
            Designed by <a href="https://www.instagram.com/fericorajinngaji?igsh=MTJ1cWZzbTN5OTQxZg%3D%3D&utm_source=qr" target="_blank">Ferico febriansyah</a>
        </div>
    </footer><!-- End Footer -->
